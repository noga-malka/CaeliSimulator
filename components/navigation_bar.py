...
navigation_bar = dash_bootstrap_components.Nav([
    create_navigation_link(NavigationBarIcons.MANAGE_PROFILES, PageTitles.MANAGE_PROFILES, PageRoutes.MANAGE_PROFILES),
    create_navigation_link(NavigationBarIcons.MANAGE_TEST_CASES, PageTitles.MANAGE_TEST_CASES, PageRoutes.MANAGE_TEST_CASES),
