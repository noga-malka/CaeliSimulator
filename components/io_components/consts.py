class SimulatorConsts:
    ...
    OPTIONS_DROPDOWN = 'simulator_options_dropdown'
    SYNC_OPTIONS = 'simulator_sync_options'
    CONNECT_DEVICE = 'simulator_connect_device'

    OPEN_CONNECT_MODAL = 'simulator_open_connect_modal_button'
